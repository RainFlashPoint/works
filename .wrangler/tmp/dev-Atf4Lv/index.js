...
// .wrangler/tmp/bundle-7hlBjf/strip-cf-connecting-ip-header.js
...
function graphqlImpl(args) {
  ...
  const validationErrors = validate(schema2, document);
...
`);
var root = /* @__PURE__ */ __name((env) => ({
  chat: /* @__PURE__ */ __name(async ({ model, messages }) => {
    try {
      console.log(JSON.stringify(env), 1e5);
      ...
      console.log("\u{1F4E4} OpenAI response:", text);
      if (!res.ok) {
      ...
      console.error("\u{1F525} OpenAI \u8BF7\u6C42\u5F02\u5E38:", err);
...
// .wrangler/tmp/bundle-7hlBjf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7hlBjf/middleware-loader.entry.ts
